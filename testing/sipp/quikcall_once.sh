...
$TESTDIR/sipp -sf $TESTDIR/uac_QuickCall.xml $TESTIP -s TEST -l 1 -r 1 -m 1 --trace_err -watchdog_minor_maxtriggers 99999 -watchdog_major_maxtriggers 99999 2>> $LOGDIR/quickcall_once.log
