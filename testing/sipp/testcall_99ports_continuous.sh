...
$TESTDIR/sipp -sf $TESTDIR/uac_pcap_MainMenu.xml $TESTIP -s TEST -l 99 -r 1 -m 100000 --trace_err -watchdog_minor_maxtriggers 99999 -watchdog_major_maxtriggers 99999 2>> $LOGDIR/testcall.log
