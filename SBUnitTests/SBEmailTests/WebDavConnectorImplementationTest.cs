...
namespace SBEmailTests
{
    ...
    public class WebDavConnectorImplementationTest : EmailTestBase
	{
		...
		public void Setup()
		{
			m_connector = new WebDavConnectorImplementation(eEmailServerType.Exchange2007WebDAV);
		...
		[Test]
		[Ignore("This test fails with a WebException \"The remote name could not be resolved: 'testex07.testdc08.local'\"")]
