...
class firstbootWindow:
    ...
    def finishClicked(self, *args):
        try:
            # Finish the SpeechBridge install steps
            os.system("/home/speechbridge/software/sbpostinstall.sh")
            os.system("cp -fb /home/speechbridge/software/sbpostinstall.sh /home/speechbridge/software/sbpostinstall.sh")
            os.system("cp -f /home/speechbridge/software/sbpostinstall_POSTFIRSTBOOT.sh /home/speechbridge/software/sbpostinstall.sh")
            os.system("service speechbridged restart")
