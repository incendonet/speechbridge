Summary: SpeechBridge 3.0.1 Update
Name: sbupdate
Version: 3.0.1
Release: 301
License: Incendonet
Group: Applications/Communications
Source: /opt/speechbridge/update/sbupdate_3-0-1-0.tar.gz
...
%description
This package will update your installation to SpeechBridge 3.0.1
...
mv -f %{BIN}/AudioRtr_C5_20101020.up               %{BIN}/AudioRtr_C5_20101020 >> %{INSTLOG} 2>> %{INSTLOG}
...
ln -fs %{BIN}/AudioRtr_C5_ShoretelSip %{BIN}/AudioRtr                               >> %{INSTLOG} 2>> %{INSTLOG}
...
%attr(0550,speechbridge,speechbridge) %{BIN}/AudioRtr_C5_20101020.up
