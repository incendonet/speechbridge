...
mv -f %{SBCONF}/assets/docs/SpeechBridgeAdminGuide_3-1.pdf.up              %{SBCONF}/assets/docs/SpeechBridgeAdminGuide_3-1.pdf >> %{INSTLOG} 2>> %{INSTLOG}
mv -f %{SBCONF}/assets/docs/SBPB_UpgradingTo_3-1-1.pdf.up                  %{SBCONF}/assets/docs/SBPB_UpgradingTo_3-1-1.pdf >> %{INSTLOG} 2>> %{INSTLOG}
...
rm -rf %{SBCONF}/assets/docs/SpeechBridgeAdminGuide_3-1.pdf                         >> %{INSTLOG} 2>> %{INSTLOG}
rm -rf %{SBCONF}/assets/docs/SBPB_UpgradingTo_3-1-1.pdf.up                          >> %{INSTLOG} 2>> %{INSTLOG}
...
%attr(0440,speechbridge,speechbridge) %{SBCONF}/assets/docs/SpeechBridgeAdminGuide_3-1.pdf.up
%attr(0440,speechbridge,speechbridge) %{SBCONF}/assets/docs/SBPB_UpgradingTo_3-1-1.pdf.up
...
- Updated for SpeechBridge 3.1.1
