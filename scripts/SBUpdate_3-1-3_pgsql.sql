...
--INSERT INTO tblConfigParams (sGroupName, sServerIP, sComponent, sName, sLabel, sValue, sHint, bAdvanced) Values ('HQ_0', '', 'Apps:global:0001', 'EDNoiseLevel', 'Speech Energy Detector Level', '1600', 'The level used by the speech energy detector to determine when someone is speaking, between 0 and 32000.  Lower values make the ED more sensitive.  Default is 1600.', '1');
...
UPDATE tblConfigParams SET sHint = 'When enabled, callers can start speaking before the greeting finishes playing.  Disable this if you are having speech recognition problems on analog trunks.  After changing this value click the "Generate VoiceXML..." button on the User Directory page.' WHERE sComponent = 'Apps:SpeechAttendant:0002';
