...
Source: /opt/speechbridge/update/sbupdate_1-4-0.tar.gz
...
%description
This SpeechBridge update installs 1.4.0
...
chmod ug+w %{VDS}/Prompts/ThankYouForCalling.wav > /dev/null 2> /dev/null
chmod ug+w %{VDS}/Prompts/PleaseSayTheName.wav > /dev/null 2> /dev/null
